...
2. **Open your report with `scope-recon`'s raw output.** Naming the tool did not make an agent reach for
   it; requiring the output did. **What fires is a schema, not an exhortation.**
